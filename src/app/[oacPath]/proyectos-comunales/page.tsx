// src/app/[oacPath]/proyectos-comunales/page.tsx
'use client'

import React from 'react';
import { usePathname } from 'next/navigation';

const ProyectosComunalesPage = () => {
    ...
    return (
        <div>
            ...
            <p>Aquí se mostrarán los proyectos de la organización {oacFormattedName}.</p>
        </div>
    );
};

export default ProyectosComunalesPage;
