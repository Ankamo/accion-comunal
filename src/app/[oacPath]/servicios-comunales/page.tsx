// src/app/[oacPath]/servicios-comunales/page.tsx
'use client'

import React from 'react';
import { usePathname } from 'next/navigation';

const ServiciosComunalesPage = () => {
    ...
    return (
        <div>
            ...
            <p>Aquí se mostrarán los servicios de la organización {oacFormattedName}.</p>
        </div>
    );
};

export default ServiciosComunalesPage;
